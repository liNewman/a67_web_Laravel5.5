...
class ArticleClick2Controller extends Controller
{
    //
    ...
    public function create(){
        return view('Study.article2.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($res){
            return redirect('/study/article2/list');
        }
        return redirect('/study/article2/create');

    }

    public function list(){
        $assign['article_list']=Article::get();
        return view('study.article2.list',$assign);
    }
