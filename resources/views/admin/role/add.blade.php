    ...
    <div class="contentpanel">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body panel-body-nopadding">
                ...
                <form class="form-horizontal form-bordered" method="post" action="/admin/role/doadd">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-sm-3 control-label" >角色名称</label>
                        <div class="col-sm-6">
                            <input type="text" placeholder="输入角色名称"  name="role_name" id="disabledinput" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" >角色描述</label>
                        <div class="col-sm-6">
                            <input type="text" placeholder="输入角色描述"  name="description" id="disabledinput" class="form-control" />
                        </div>
                    </div>
