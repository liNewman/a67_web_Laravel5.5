  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        <li class="active"><a href="http://www.a67web.com/admin/home"><i class="fa fa-home"></i> <span>首页</span></a></li>
        <li class="nav-parent"><a href=""><i class="fa fa-edit"></i> <span>RBAC管理</span></a>
          <ul class="children">
